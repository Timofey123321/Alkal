	...
	<body>
		...
		<div id="content">
			...
			<h1>
				...
				elseif (($hour >18)&&($hour <24)) $welcome = 'Добрый вечер,'; echo $welcome  ?> Гость! </h1>
			<!-- Заголовок -->
		...
		<div id="nav">
			...
			<!-- Меню -->
			<?php $leftMenu = [['link'=>'Домой', 'href'=>'index.php'],['link'=>'О нас', 'href'=>'about.php'],['link'=>'Контакты', 'href'=>'contact.php'],['link'=>'Таблица','href'=>'table.php']];?>
			<ul>
